...
export const getArticles = async (): Promise<BaseArticle[]> => { //all articles from db
...
export const getArticleById = async <K extends string, T extends BaseArticle<K>>(id: string): Promise<T> => { //return a single article (the id)
